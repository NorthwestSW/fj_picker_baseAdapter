...
package com.supcon.baseadapter;
...
public class BGABindingRecyclerViewAdapter<M, B extends ViewDataBinding> extends RecyclerView.Adapter<BGABindingViewHolder<B>> {
    ...
    public void onBindViewHolder(BGABindingViewHolder<B> viewHolder, int position) {
        ...
        binding.setVariable(com.supcon.baseadapter.BR.viewHolder, viewHolder);
        binding.setVariable(com.supcon.baseadapter.BR.model, model);
        binding.setVariable(com.supcon.baseadapter.BR.itemEventHandler, mItemEventHandler);
